...
from test.testbed.litsearch_eval.evaluator import SearchEvaluator
...
if __name__ == '__main__':
    config_path = Path("/data3/guofang/AIgnite-Solutions/AIgnite/test/configs/litsearch_testbed_config_gritlm.yaml")
